...
public class ExtMath {
	 ...
	 *          true if a does not exceed the largest possible
	 *          value in the type long diminished with b; false
	 *          otherwise.
	 *          | if ( (a > 0) && (b > 0) )
	 *          |   then result == (a <= Long.MAX_VALUE - b)
	 * @return  If the given integer numbers are both negative,
	 *          true if a is not below the smallest possible
	 *          value in the type long incremented with b;
	 *          false otherwise.
	 *          | if ( (a < 0) && (b < 0) )
	 *          |   then result == (a >= Long.MIN_VALUE - b)
	 * @return  True if the given integer numbers have different
	 *          signs.
	 *          | if ( ( (a <= 0) && (b >= 0) ) ||
	 *          |      ( (a >= 0) && (b <=0) ) )
	 *          |   then result == true
	 ...
	 *          true if the absolute value of a does not exceed
	 *          the largest possible value in the type long
	 *          divided by the absoulte value of b; false
	 *          otherwise.
	 *          | if ( ( (a > 0) && (b > 0) ) ||
	 *          |      ( (a < 0) && (b < 0) ) )
	 *          | then
	 ...
	 * @return  If a is positive and b is negative, true if b is
	 *          not below the smallest possible value in the type
	 *          long divided by a; false otherwise.
	 *          | if ( (a > 0) && (b < 0) )
	 *          |   then result == (b >= Long.MIN_VALUE / a)
	 * @return  If b is positive and a is negative, true if a is
	 *          not below the smallest possible value in the type
	 *          long divided by b; false otherwise.
	 *          | if ( (a < 0) && (b > 0) )
	 *          |   then result == (a >= Long.MIN_VALUE / b)
	 * @return  True if a is zero or if b is zero.
	 *          | if ( (a == 0) || (b == 0) )
	 *          |   then result == true
	 */
	 ...
	 * @return  +1 if the given integer number is positive;
	 *          -1 if the given integer number is negative;
	 *          0 if the given integer number is 0.
	 *          | if (a > 0)
	 *          |   then result == 1
	 *          | else if (a < 0)
	 *          |   then result == -1
